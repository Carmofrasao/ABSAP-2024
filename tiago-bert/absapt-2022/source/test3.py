...
# https://www.kaggle.com/code/leandrodoze/examples-from-nltk-book-in-portuguese/notebook
...
# https://www.kaggle.com/code/bavalpreet26/ner-using-crf/notebook
...
# for each_string, each_y_pred in zip(X_test, y_pred):
#     print(each_string)
#     print(each_y_pred)
